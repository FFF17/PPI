    ...
    <div class="col-lg-4 col-md-4">
        <div class="card">
            <div class="card-header card-header-primary" style="background:#EE9B21">
                <h4 style="text-align:center">PENDAFTAR</h4>
                <h1 class="card-title">
    ...
    <div class="col-lg-4 col-md-4">
        <div class="card">
            <div class="card-header card-header-primary" style="background:#EE9B21">
                ...
                <h1 class="card-title">
                    <center><?= $total_penilaian->num_rows(); ?></center>
                </h1>
            </div>
            <div class="card-body">
            </div>
            ...
            <div class="card-body">
                <table class="table">
                    <thead>
                        ...
                        <thead>
                        <tbody>
                            <?php foreach ($total_penilaian->result() as $tmp) : ?>
                                <tr>
                                    <td><?php echo $tmp->nama; ?></td>
                                    <td><?php echo $tmp->daerah; ?></td>
                                    <td width="10%"><?php echo $tmp->score; ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                </table>
