...
<script>
    ...
    function add(){
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo base_url()?>lokasi/add"
        }).done(function (msg) {
            processDone();
    ...
    function edit(id){
        ...
        $.ajax({
            method: "POST",
            url: "<?php echo base_url()?>lokasi/edit",
            data: { 
                id: id
            }
        }).done(function (msg) {
    ...
    function hapus(id){
        Swal.fire({
            title: 'Hapus data',
            text: "Apakah anda yakin akan meghapus alamat kantor?",
            type: 'error',
            ...
            if (result.value) {
                ...
                $.ajax({
                    ...
                    if (msg != "") {
                        ...
                        $.notify({
                            icon: "add_alert",
                            message: "Info, <b>Kantor Deleted</b>"
                        }, {
                            type: 'info',
                            timer: 1000,
                            placement: {
