                ...
                <div class="row">
                    ...
                    <div class="col-md-2 pt-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="no_surat" name="no_surat" value="<?= $st->no_surat_tugas; ?>">
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select" onchange="masaBerlaku()" id="masa_berlaku" data-style="btn btn-link" name="masa_berlaku" required>
                                <option <?= $st->masa_berlaku == 12 ? 'selected' : ''; ?> value="12">12 (Dua Belas)</option>
                                <option <?= $st->masa_berlaku == 30 ? 'selected' : ''; ?> value="30">30 (Tiga Puluh)</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2 pt-3">
                        <div class="form-group">
                            ...
                            <input type="input" class="form-control" name="start_date" id="start_date" value="<?= $st->start_date; ?>" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 pt-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-9" id="alias_masa_berlaku">: <?= $st->masa_berlaku == 12 ? '12 (Dua Belas)' : '30 (Tiga Puluh)'; ?></div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">
                                <b>@sekertaris</b>
                            ...
                            <div class="col-md-9">
                                : <input type="text" style="width:500px" id="sekertaris" name="sekertaris" value="<?= $st->sekertaris; ?>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12 text-right">
                        <button type="button" onclick="btnSave()" class="btn btn-success btn-round"><i class="fa fa-edit"></i> Update</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        if ($('#jenis_surat_tugas').val() == 'pasangan' && $('#pasangan').val() > 0 && $('#no_surat').val() != '' && $('#start_date').val() != '' && $('#sekertaris').val() != '') {
            $.ajax({
                ...
                data: {
                    ...
                    action: 'edit',
                    no_surat_before: '<?= $st->no_surat_tugas; ?>',
                ...
                if (msg == 1) {
                    ...
                    saveData('update_surat_tugas_pasangan_pdf');
                }
            });
            ...
            $.ajax({
                ...
                if (msg == 1) {
                    ...
                    saveData('update_surat_tugas_pdf');
                }
            });
        } else {
        ...
        if ($('#jenis_surat_tugas').val() == 'pasangan') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    kabupaten: $("#kabupaten").val(),
                    action: 'edit',
                    nama: <?= $st->id_pasangan == '' ? 0 : $st->id_pasangan; ?>,
                    calon: "<?= $st->nama_pasangan; ?>"
                }
            }).done(function(msg) {
                $("#pasangan").html(msg);
            });
