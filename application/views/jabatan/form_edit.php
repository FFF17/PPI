                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select class="form-control select" data-style="btn btn-link" name="tingkat" required>
                                <option <?php echo ($data->tingkat=="PIMNAS")?"selected":""?>>PIMNAS</option>
                                <option <?php echo ($data->tingkat=="PIMDA")?"selected":""?>>PIMDA</option>
                                <option <?php echo ($data->tingkat=="PIMCAB")?"selected":""?>>PIMCAB</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-12">
